...
| 01 | What a language model actually is | Next-token prediction, training vs inference, why it "knows" things and why it makes things up — the one mental model everything else builds on | durable | researching — pilot (D-006), session R1 2026-08-13 |
